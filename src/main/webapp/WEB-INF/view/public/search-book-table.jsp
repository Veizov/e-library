...
<c:if test="${not empty books}">
    ...
    <table class="responsive-table striped">
        ...
        <tr>
            ...
            <th data-sort="year" class="table-sorter"><spring:message code="label.year"/></th>
            <th class="w120px align-center-i"><spring:message code="table.options"/></th>
        </tr>
        </thead>
        <tbody>
        <c:forEach var="book" items="${books}" varStatus="status">
            <tr>
                ...
                <td class="no-padding w150px">
                    ...
                    <a class="mR5px" href="javascript:void(0)" title="<spring:message code="btn.edit"/>">
                        <img class="img24" src="<c:url value="/resources/images/edit-icon.png"/>"/>
                    </a>
                    <a class="mR5px" href="javascript:void(0)" title="<spring:message code="btn.delete"/>">
